...
model_alpha = TopicModelling(text=articles_python["text"],
...
model_beta = TopicModelling(text=articles_python["text"],
...
model_beta_dict = {0 : 'machine learning',
                    ...
                    4 : 'machine learning',
                    5 : 'machine learning',
                    6 : 'regressors and classifiers',
                    7 : 'natural language processing',
                    8 : 'general data science',
                    9 : 'general data science'}
